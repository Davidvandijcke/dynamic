...
*****************************
***Switching to sugar/diet alternatives
*****************************
...
sa "$P/elasticities_tableA.dta",replace
...
sa "$P/catelas_preidctions.dta",replace

u "$P/catelas_preidctions.dta",clear
...
sa "$P/elasticities_tableB.dta",replace
