...
**************************************************************************
***Counterfactuals - with equilibrium pass-through
**************************************************************************
u "$P/logit_coefficients.dta",clear

drop price rm
merge 1:1 csindex product using "$P/Passthrough/pricesimulations.dta"
drop _m
...
sa "$P/Passthrough/tax_predictions.dta",replace
         
u "$P/Passthrough/tax_predictions.dta",clear
...
sa "$P/Passthrough/product_price.dta",replace
...
sa "$P/Passthrough/tax_product_predictions.dta",replace
...
sa "$P/Passthrough/tax_predictions_agg.dta",replace

u "$P2/purchyearfull.dta",clear

keep hhno indvno year age annaddsr annexp_eq agecat asgrp eegrp

merge 1:1 hhno indvno year using "$P/Passthrough/tax_predictions_agg.dta"
keep if _m==3
drop _m

sa "$P/Passthrough/tax_predictions_demogs.dta",replace
